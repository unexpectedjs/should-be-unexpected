...
function err(fn, msg) {
    try {
        ...
        // replaces the linebreak at the start of the line that
        // unexpected puts in for readability
        should.equal(msg, err.message.replace(/^\n/, ''));
    }
}
...
function err_should_exist(obj) {
    err(function() {
        should.exist(obj);
    }, 'expected ' + should.format(obj) + ' to be defined');
}
